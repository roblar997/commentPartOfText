...
public class TidslinjeDAO {
    ...
    public List<Tidslinje> getTidslinjer(){
      ...
      /*  EntityManager em = emf.createEntityManager();
        ...
        //String sql2 =  "SELECT * FROM \"schemaTest\".\"Tidslinje\" WHERE \"isdeleted\" IS False";
       // List<Tidslinje> tidslinjer = db.query(sql2, new BeanPropertyRowMapper(Tidslinje.class));
        //return tidslinjer;
